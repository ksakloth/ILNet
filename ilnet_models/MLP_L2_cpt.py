...
def load_data(taskname,dataset,category):
    ...
    print(arr.shape)
    return arr
X_train=load_data('cpt_','training_','features')
X_test=load_data('cpt_','testing_','features')
y_train=load_data('cpt_','training_','target')
y_test=load_data('cpt_','testing_','target')
...
# params= {"mlp1_units":16, "mlp2_units":16,'dropval':0.5}
