...
def load_data(taskname,ion,dataset,category):
    ...
    print(arr.shape)
    return arr
X_cation_train=load_data('density_','cation_','training_','features')
X_anion_train=load_data('density_','anion_','training_','features')
X_TP_train=load_data('density_','TP_','training_','features')

X_cation_test=load_data('density_','cation_','testing_','features')
X_anion_test=load_data('density_','anion_','testing_','features')
X_TP_test=load_data('density_','TP_','testing_','features')

y_train=load_data('density_','salt_','training_','target')
y_test=load_data('density_','salt_','testing_','target')
...
def setup_hybrid(model1,model2,model3,params):
    ...
    #x = Dropout(0.1)(x)
    x=Dense(1,activation='linear')(merged_out)
...
# params= {"mlp1_units":16, "mlp2_units":16,'hybrid1_units':16,'hybrid2_units':16}
# print('metrics of train,val,test : '+str(params)+str(final(n_fold,X_cation_train,X_anion_train,X_TP_train,y_train,y_test)))

# params= {"mlp1_units":16, "mlp2_units":16,'hybrid1_units':32,'hybrid2_units':32}
# print('metrics of train,val,test : '+str(params)+str(final(n_fold,X_cation_train,X_anion_train,X_TP_train,y_train,y_test)))

# params= {"mlp1_units":16, "mlp2_units":16,'hybrid1_units':64,'hybrid2_units':64}
# print('metrics of train,val,test : '+str(params)+str(final(n_fold,X_cation_train,X_anion_train,X_TP_train,y_train,y_test)))

# params= {"mlp1_units":16, "mlp2_units":16,'hybrid1_units':128,'hybrid2_units':128}
# print('metrics of train,val,test : '+str(params)+str(final(n_fold,X_cation_train,X_anion_train,X_TP_train,y_train,y_test)))

# params= {"mlp1_units":16, "mlp2_units":16,'hybrid1_units':256,'hybrid2_units':256}
# print('metrics of train,val,test : '+str(params)+str(final(n_fold,X_cation_train,X_anion_train,X_TP_train,y_train,y_test)))

# params= {"mlp1_units":32, "mlp2_units":32,'hybrid1_units':16,'hybrid2_units':16}
# print('metrics of train,val,test : '+str(params)+str(final(n_fold,X_cation_train,X_anion_train,X_TP_train,y_train,y_test)))

# params= {"mlp1_units":32, "mlp2_units":32,'hybrid1_units':32,'hybrid2_units':32}
# print('metrics of train,val,test : '+str(params)+str(final(n_fold,X_cation_train,X_anion_train,X_TP_train,y_train,y_test)))

# params= {"mlp1_units":32, "mlp2_units":32,'hybrid1_units':64,'hybrid2_units':64}
# print('metrics of train,val,test : '+str(params)+str(final(n_fold,X_cation_train,X_anion_train,X_TP_train,y_train,y_test)))

# params= {"mlp1_units":32, "mlp2_units":32,'hybrid1_units':128,'hybrid2_units':128}
# print('metrics of train,val,test : '+str(params)+str(final(n_fold,X_cation_train,X_anion_train,X_TP_train,y_train,y_test)))

# params= {"mlp1_units":32, "mlp2_units":32,'hybrid1_units':256,'hybrid2_units':256}
# print('metrics of train,val,test : '+str(params)+str(final(n_fold,X_cation_train,X_anion_train,X_TP_train,y_train,y_test)))

# params= {"mlp1_units":64, "mlp2_units":64,'hybrid1_units':16,'hybrid2_units':16}
# print('metrics of train,val,test : '+str(params)+str(final(n_fold,X_cation_train,X_anion_train,X_TP_train,y_train,y_test)))

# params= {"mlp1_units":64, "mlp2_units":64,'hybrid1_units':32,'hybrid2_units':32}
# print('metrics of train,val,test : '+str(params)+str(final(n_fold,X_cation_train,X_anion_train,X_TP_train,y_train,y_test)))

# params= {"mlp1_units":64, "mlp2_units":64,'hybrid1_units':64,'hybrid2_units':64}
# print('metrics of train,val,test : '+str(params)+str(final(n_fold,X_cation_train,X_anion_train,X_TP_train,y_train,y_test)))

# params= {"mlp1_units":64, "mlp2_units":64,'hybrid1_units':128,'hybrid2_units':128}
# print('metrics of train,val,test : '+str(params)+str(final(n_fold,X_cation_train,X_anion_train,X_TP_train,y_train,y_test)))

# params= {"mlp1_units":64, "mlp2_units":64,'hybrid1_units':256,'hybrid2_units':256}
# print('metrics of train,val,test : '+str(params)+str(final(n_fold,X_cation_train,X_anion_train,X_TP_train,y_train,y_test)))

# params= {"mlp1_units":128, "mlp2_units":128,'hybrid1_units':16,'hybrid2_units':16}
# print('metrics of train,val,test : '+str(params)+str(final(n_fold,X_cation_train,X_anion_train,X_TP_train,y_train,y_test)))

# params= {"mlp1_units":128, "mlp2_units":128,'hybrid1_units':32,'hybrid2_units':32}
# print('metrics of train,val,test : '+str(params)+str(final(n_fold,X_cation_train,X_anion_train,X_TP_train,y_train,y_test)))

# params= {"mlp1_units":128, "mlp2_units":128,'hybrid1_units':64,'hybrid2_units':64}
# print('metrics of train,val,test : '+str(params)+str(final(n_fold,X_cation_train,X_anion_train,X_TP_train,y_train,y_test)))

# params= {"mlp1_units":128, "mlp2_units":128,'hybrid1_units':128,'hybrid2_units':128}
# print('metrics of train,val,test : '+str(params)+str(final(n_fold,X_cation_train,X_anion_train,X_TP_train,y_train,y_test)))

# In[ ]:

params= {"mlp1_units":128, "mlp2_units":128,'hybrid1_units':256,'hybrid2_units':256}
print('metrics of train,val,test : '+str(params)+str(final(n_fold,X_cation_train,X_anion_train,X_TP_train,y_train,y_test)))


# params= {"mlp1_units":256, "mlp2_units":256,'hybrid1_units':16,'hybrid2_units':16}
# print('metrics of train,val,test : '+str(params)+str(final(n_fold,X_cation_train,X_anion_train,X_TP_train,y_train,y_test)))

# params= {"mlp1_units":256, "mlp2_units":256,'hybrid1_units':32,'hybrid2_units':32}
# print('metrics of train,val,test : '+str(params)+str(final(n_fold,X_cation_train,X_anion_train,X_TP_train,y_train,y_test)))

# params= {"mlp1_units":256, "mlp2_units":256,'hybrid1_units':64,'hybrid2_units':64}
# print('metrics of train,val,test : '+str(params)+str(final(n_fold,X_cation_train,X_anion_train,X_TP_train,y_train,y_test)))

# params= {"mlp1_units":256, "mlp2_units":256,'hybrid1_units':128,'hybrid2_units':128}
# print('metrics of train,val,test : '+str(params)+str(final(n_fold,X_cation_train,X_anion_train,X_TP_train,y_train,y_test)))

# params= {"mlp1_units":256, "mlp2_units":256,'hybrid1_units':256,'hybrid2_units':256}
# print('metrics of train,val,test : '+str(params)+str(final(n_fold,X_cation_train,X_anion_train,X_TP_train,y_train,y_test)))
