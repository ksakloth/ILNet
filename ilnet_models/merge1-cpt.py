...
def load_data(taskname,ion,dataset,category):
    ...
    print(arr.shape)
    return arr
X_cation_train=load_data('cpt_','cation_','training_','features')
X_anion_train=load_data('cpt_','anion_','training_','features')
X_TP_train=load_data('cpt_','TP_','training_','features')

X_cation_test=load_data('cpt_','cation_','testing_','features')
X_anion_test=load_data('cpt_','anion_','testing_','features')
X_TP_test=load_data('cpt_','TP_','testing_','features')

y_train=load_data('cpt_','salt_','training_','target')
y_test=load_data('cpt_','salt_','testing_','target')
